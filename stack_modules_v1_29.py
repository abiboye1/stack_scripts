...
#Creating Server Access Log2
# AWS Whitepapers - https://docs.aws.amazon.com/AmazonS3/latest/userguide/enable-server-access-logging.html
		...
		response = s3_client.put_bucket_logging(
			...
			BucketLoggingStatus={
				'LoggingEnabled': {
					...
					'TargetPrefix': 'stackbuckabibsep23-logs'}})
		print("\n" + str(response))
