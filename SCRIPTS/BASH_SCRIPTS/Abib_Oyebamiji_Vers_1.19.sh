...
#	scp -r -i $private_key "$source_path_backup/${x}_${RUNNER}_${TS}.dmp" $destination_server:$destination_path_backup
	...
	for y in $schemas
	do
		previous_dest=$destination_path	
...
EOF
		...
		source_path=$source_path_backup/${y}_${RUNNER}_${TS}.tar
		destination_path=$destination_path_backup
		secure_copy $private_key $source_path $destination_server:$destination_path
		...
		destination_path=$previous_dest
		secure_copy $private_key $source_path $destination_server:$destination_path
		echo
		echo ${destination_path}
		echo
		echo
#		ssh -i $private_key $destination_server "tar -xvf ${destination_path_backup}${y}_${RUNNER}_${TS}.tar -C $destination_path_backup" 
		ssh -i $private_key $destination_server "tar -xvf ${destination_path_backup}/${y}_${RUNNER}_${TS}.tar"
#		ssh -i $private_key $destination_server:$destination_path_backup "tar -xvf ${destination_path_backup}/${y}_${RUNNER}_${TS}.tar"
#		ssh -i $private_key $destination_server:$destination_path_backup "tar -xvf ${source_path_backup}/${x}_${RUNNER}_${TS}.tar"
		#ssh -i $private_key oracle@$destination_server "tar -xvf ${source_path_backup}/${x}_${RUNNER}_${TS}.tar -C $destination_path_backup"
