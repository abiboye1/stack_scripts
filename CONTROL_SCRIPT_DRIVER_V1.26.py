...
import stack_modules_v1_26 as sm, sys
	...
	#Checking decision for Data Migration function call
   	...
   	#Checking if only one argument is passed and taking inputs
		if len(sys.argv) - 1 == 1:
			...
			sm.empty_bucket_content(bucket=sys.argv[2], object1=sys.argv[3], object2=sys.argv[4], object3=sys.argv[5], object4=sys.argv[6], object5=sys.argv[7], object6=sys.argv[8])
